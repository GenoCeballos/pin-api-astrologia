                        ...
                        <tbody>
                          <tr>
                            <td class="v-container-padding-padding"
                              style="overflow-wrap:break-word;word-break:break-word;padding:60px 10px 20px;font-family:'Open Sans',sans-serif;"
                              align="left">

                              <h1 class="v-font-size"
                                style="margin: 0px; line-height: 130%; text-align: center; word-wrap: break-word; font-family: Epilogue; font-size: 32px; ">
                                <strong>Bienvenid@</strong><br /><strong>Estamos para vos</strong></h1>
                    ...
                    <div
                      ...
                      <table id="u_content_text_1" style="font-family:'Open Sans',sans-serif;" role="presentation"
                        ...
                        <tbody>
                          <tr>
                            <td class="v-container-padding-padding"
                              style="overflow-wrap:break-word;word-break:break-word;padding:60px 30px 10px;font-family:'Open Sans',sans-serif;"
                              align="left">

                              <div class="v-font-size"
                                style="line-height: 140%; text-align: justify; word-wrap: break-word;">
                                <p style="font-size: 14px; line-height: 140%;text-transform: capitalize">
                                  <strong>Hola {{$details['nombre']}},{{$details['apellido']}} !!!</strong></p>
                                <p style="font-size: 14px; line-height: 140%;"> </p>
                                <p style="font-size: 14px; line-height: 140%; text-transform: capitalize ">
                                  <b>{{$details['nombre']}}:</b> Lorem ipsum dolor sit amet, consect etur
                                  adip iscing elit, sed do eius mod temp or incid idunt ut labore et dolore magna aliqua
                                  quis ipsum suspend isse ultrices gravida liqua quis ipsum magna.</p>
                              </div>
                          ...
                          <tr>
                            <td class="v-container-padding-padding"
                              ...
                              <div class="v-font-size"
                                ...
                                <p style="font-size: 14px; line-height: 140%;"><strong>it takes just a minute - click to
                                    leave a review</strong></p>
                              </div>
                            ...
                            <td class="v-container-padding-padding"
                              ...
                              <div align="left">
                                ...
                                <a href="" target="_blank" class="v-button v-size-width v-font-size"
                                  style="box-sizing: border-box;display: inline-block;font-family:'Open Sans',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #ff5770; border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px; width:30%; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 14px;">
                                  <span style="display:block;padding:10px 20px;line-height:120%;"><span
                                      style="font-size: 14px; line-height: 16.8px;">Review Us</span></span>
                                </a>
                      ...
                      <table id="u_content_text_3" style="font-family:'Open Sans',sans-serif;" role="presentation"
                        ...
                        <tbody>
                          <tr>
                            <td class="v-container-padding-padding"
                              style="overflow-wrap:break-word;word-break:break-word;padding:10px 10px 60px 30px;font-family:'Open Sans',sans-serif;"
                              align="left">
                              ...
                              <div class="v-font-size"
                                ...
                                <p style="font-size: 14px; line-height: 140%;">
                                  <span style="color: #ff5770; font-size: 16px; line-height: 19.6px;"><strong>C-2</strong>
                                    <b><em>Tarot y Astrología.</em></b>
                                  </span>
                                </p>
                                <p style="font-size: 14px; line-height: 140%;">Staff @chechu @cin</p>
                              </div>
